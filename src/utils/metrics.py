...
def roc_aucs(labels, preds, average=None):
    return metrics.roc_auc_score(labels, preds, average=average)

def pr_aucs(labels, preds, average=None):
    prauc = metrics.average_precision_score(labels, preds, average=average)
    return prauc
